...
my_name = "Minoo" # Change to your name
my_github_account = "https://github.com/minoo04" # Change to your GitHub account
my_hobby = "Learning new things, dancing and watching anime" # Change to your hobby
hours_coding_per_week = "10" # How many hours per week would you like to devote to learn coding?
